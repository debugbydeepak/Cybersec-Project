...
class PipelineService:
    ...
    def run_tests(self):
        ...
        try:
            ...
            res = subprocess.run([sys.executable, "-m", "pytest", "tests"], capture_output=True, text=True) # nosec
            if res.returncode == 0:
    ...
    def run_security_scan(self):
        ...
        try:
            ...
            res = subprocess.run(["bandit", "-r", target], capture_output=True, text=True) # nosec
    ...
    def run_auto_fix(self):
        ...
        target_dir = os.path.join(self.root_dir, "app")
